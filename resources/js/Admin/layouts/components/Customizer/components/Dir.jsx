...
import ltr from "@admin/assets/images/layouts/dir-ltr.png";
import rtl from "@admin/assets/images/layouts/dir-rtl.png";
...
const Direction = () => {
  ...
  return <div id="dir" className="p-3 border-bottom border-dashed">
      <h5 className="mb-3 fw-bold">Layout Direction</h5>

      <Row className="g-3">
        {directionOptions.map(option => <Col xs={4} key={option.value}>
