...
import boxedImg from '@admin/assets/images/layouts/width-boxed.png';
import fluidImg from '@admin/assets/images/layouts/width-fluid.png';
const widthOptions = [{
  value: 'fluid',
  image: fluidImg
}, {
...
const Width = () => {
  ...
  return <div id="width" className="p-3 border-bottom border-dashed">
      <h5 className="mb-3 fw-bold">Layout Width</h5>
      <div className="row g-3">
        {widthOptions.map(option => <Col xs={4} id={`width-${option.value}`} key={option.value}>
