import darkImg from '@admin/assets/images/layouts/topbar-color-dark.png';
import gradientImg from '@admin/assets/images/layouts/topbar-color-gradient.png';
import grayImg from '@admin/assets/images/layouts/topbar-color-gray.png';
import lightImg from '@admin/assets/images/layouts/topbar-color-light.png';
...
const TopBarColor = () => {
  ...
  return <div id="topbar-color" className="p-3 border-bottom border-dashed">
      <h5 className="mb-3 fw-bold">Topbar Color</h5>
      <div className="row g-3">
        {topbarColorOptions && topbarColorOptions.map(option => <div className="col-4" id={`topbar-color-${option.value}`} key={option.value}>
