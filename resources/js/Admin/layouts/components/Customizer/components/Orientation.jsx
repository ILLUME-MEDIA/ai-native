...
import verticalImg from '@admin/assets/images/layouts/sidenav-color-dark.png';
import horizontalImg from '@admin/assets/images/layouts/sidenav-size-offcanvas.png';
...
const Orientation = () => {
  ...
  return <div id="orientation" className="p-3 border-bottom border-dashed">
      <h5 className="mb-3 fw-bold">Orientation</h5>
      <div className="row g-3">
        {orientationOptions && orientationOptions.map(option => <div className="col-4" id={`orientation-${option.value}`} key={option.value}>
