import darkImg from '@admin/assets/images/layouts/sidenav-color-dark.png';
import gradientImg from '@admin/assets/images/layouts/sidenav-color-gradient.png';
import grayImg from '@admin/assets/images/layouts/sidenav-color-gray.png';
import imageImg from '@admin/assets/images/layouts/sidenav-color-image.png';
import lightImg from '@admin/assets/images/layouts/sidenav-color-light.png';
...
const SidenavColor = () => {
  ...
  return <div id="sidenav-color" className="p-3 border-bottom border-dashed">
      <h5 className="mb-3 fw-bold">Sidenav Color</h5>
      <div className="row g-3">
        {sidenavColorOptions && sidenavColorOptions.map(option => <div className="col-4" id={`sidenav-color-${option.value}`} key={option.value}>
