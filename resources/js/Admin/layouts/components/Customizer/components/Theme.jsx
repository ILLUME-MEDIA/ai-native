import darkImg from '@admin/assets/images/layouts/theme-dark.png';
import lightImg from '@admin/assets/images/layouts/theme-light.png';
import systemImg from '@admin/assets/images/layouts/theme-system.png';
...
const Theme = () => {
  ...
  return <div id="theme" className="p-3 border-bottom border-dashed">
      <h5 className="mb-3 fw-bold">Color Scheme</h5>
      <div className="row">
        {themeOptions.map(item => <div className="col-4" id={`theme-${item.value}`} key={item.value}>
