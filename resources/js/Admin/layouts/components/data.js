export const menuItems = [{
  ...
  children: [{
    ...
    children: [{
      ...
      url: "/apps/ecommerce/muzzhub-categories",
      ...
      children: [{
        ...
        url: "/apps/ecommerce/menu-modifiers",
        slug: "pages:apps-ecommerce-menu-modifiers",
  ...
  children: [ {
    ...
    icon: "clock",
    url: "/ai/duties",
    slug: "pages:ai-duties",
    label: "Automated Duties"
  }, {
    icon: "video",
    url: "/ai/scrapers",
