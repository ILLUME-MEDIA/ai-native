...
const Megamenu = () => {
  return <div id="megamenu-apps" className="topbar-item d-none d-md-flex">
    <Dropdown>
      <DropdownToggle className="topbar-link btn fw-medium btn-link drop-arrow-none px-2" type="button">
        Apps <Icon icon="chevron-down" className="ms-1" />
      </DropdownToggle>
      <DropdownMenu className="dropdown-menu-xxl p-0" style={{ minWidth: 740 }}>
        <div className="h-100" style={{
          ...
          <Row className="g-0">
                  ...
                  <div className="p-2">
                    <DropdownItem href="">
                      <span className="d-flex align-items-center">
                        ...
                        <span>
                          <h5 className="fs-14 mb-0 lh-base">eCommerce</h5>
                    ...
                    <DropdownItem href="" className="my-2">
                      <span className="d-flex align-items-center">
                        ...
                        <span>
                          <h5 className="fs-14 mb-0 lh-base">Chat</h5>
                    ...
                    <DropdownItem href="" className="my-2">
                      <span className="d-flex align-items-center">
                        ...
                        <span>
                          <h5 className="fs-14 mb-0 lh-base">Task</h5>
                          <span className="text-muted fs-12">UI/UX Team</span>
                        </span>
                      </span>
                    </DropdownItem>
                    <DropdownItem href="" className="mt-2">
                      <span className="d-flex align-items-center">
                        ...
                        <span>
                          <h5 className="fs-14 mb-0 lh-base">Email</h5>
                          <span className="text-muted fs-12">UI/UX Team</span>
                        </span>
                      </span>
                    </DropdownItem>
                  ...
                  <div className="p-2">
                    <DropdownItem href="">
                      <span className="d-flex align-items-center">
                        ...
                        <span>
                          <h5 className="fs-14 mb-0 lh-base">Companies</h5>
                          <span className="text-muted fs-12">UI/UX Team</span>
                        </span>
                      </span>
                    </DropdownItem>
                    <DropdownItem href="" className="my-2">
                      <span className="d-flex align-items-center">
                        ...
                        <span>
                          <h5 className="fs-14 mb-0 lh-base">
                            Contacts Diary
                          </h5>
                          <span className="text-muted fs-12">UI/UX Team</span>
                        </span>
                    ...
                    <DropdownItem href="" className="my-2">
                      <span className="d-flex align-items-center">
                        ...
                        <span>
                          <h5 className="fs-14 mb-0 lh-base">Calendar</h5>
                          <span className="text-muted fs-12">UI/UX Team</span>
                        </span>
                      </span>
                    </DropdownItem>
                    <DropdownItem href="" className="mt-2">
                      <span className="d-flex align-items-center">
                        ...
                        <span>
                          <h5 className="fs-14 mb-0 lh-base">Support</h5>
                          <span className="text-muted fs-12">UI/UX Team</span>
                        </span>
                      </span>
                    </DropdownItem>
            ...
            <Col sm={4}>
              <div className="h-100 position-relative rounded-end rounded-0 overflow-hidden" style={{
                ...
                <div className="p-3 card-img-overlay bg-gradient bg-secondary bg-opacity-90 d-flex align-items-center justify-content-center">
                  <div className="text-center  text-white">
                    ...
                    <h4 className="fw-medium fs-16 mb-1">
                      <del className="text-opacity-75 text-white">$49.00</del>{" "}
                      / <span className="fw-bold text-white">$15 USD</span>
                    </h4>
