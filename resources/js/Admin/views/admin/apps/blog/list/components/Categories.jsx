...
const Categories = () => {
  return <>
      {blogData.map((blog, index) => <article className="card flex-md-row mb-3" key={index}>
          <Col md={4}>
          ...
          <Col md={8} className="d-flex flex-column">
            <CardBody>
              ...
              <div>
                {blog.tags.map((tag, i) => <Link key={i} to="" className="badge badge-label badge-default me-1">
                    {tag}
                  </Link>)}
              </div>
