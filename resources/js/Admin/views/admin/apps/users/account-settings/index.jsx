import profile from '@admin/assets/images/profile-bg.jpg';
                  ...
                  <CardBody>
                    <Form>
                      <h5 className="mb-3 text-uppercase bg-light-subtle p-1 border-dashed border rounded border-light text-center">
                        <Icon icon="user-circle" className="me-1" /> Personal Info
                      </h5>
                      <Row>
                        <Col md={6}>
                          <div className="mb-3">
                      ...
                      <h5 className="mb-3 text-uppercase bg-light-subtle p-1 border-dashed border rounded border-light text-center">
                        <Icon icon="map-pin" className="me-1" /> Address Info
                      </h5>
                      <Row>
                        <Col md={6}>
                          <div className="mb-3">
                      ...
                      <h5 className="mb-3 text-uppercase bg-light-subtle p-1 border-dashed border rounded border-light text-center">
                        <Icon icon="building" className="me-1" /> Company Info
                      </h5>
                      <Row>
                        <Col md={6}>
                          <div className="mb-3">
                      ...
                      <h5 className="mb-3 text-uppercase bg-light-subtle p-1 border-dashed border rounded border-light text-center">
                        <Icon icon="world" className="me-1" /> Social
                      </h5>
                      <Row className="g-3">
                        <Col md={6}>
