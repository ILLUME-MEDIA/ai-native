import us from '@admin/assets/images/flags/us.svg';
import user3 from '@admin/assets/images/users/user-1.jpg';
  ...
  return <Card className="card-top-sticky">
      <CardBody>
        ...
        <div className="d-flex flex-wrap gap-1">
          {skillData.map((skill, index) => <Link key={index} className="btn btn-light btn-sm" to="">
              {skill}
            </Link>)}
        </div>
      </CardBody>
