...
import qrImg from '@admin/assets/images/qr.png';
import sign from '@admin/assets/images/sign.png';
                  ...
                  <div className="d-flex align-items-center justify-content-between mb-3 border-bottom pb-3">
                    <div className="auth-brand mb-0">
                      <Link to="/" className="logo-dark">
                        <img src={logoDark} alt="dark logo" height={26} width={103} className="img-fluid" />
                      </Link>
                      <Link to="/" className="logo-light">
                        <img src={logoLight} alt="logo" height={26} width={103} className="img-fluid" />
                      </Link>
                    </div>
