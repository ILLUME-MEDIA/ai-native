...
import { voteListData } from './components/data';
const Page = () => {
  return <>
        ...
        <Col xs={12}>
          <Card>
            ...
            <CardBody className="p-0">
              {voteListData.map((item, idx) => <div key={idx} className={clsx('px-4 py-3', idx !== voteListData.length - 1 && 'border-bottom border-dashed')}>
