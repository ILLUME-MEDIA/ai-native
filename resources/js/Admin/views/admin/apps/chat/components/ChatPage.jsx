...
import { generateInitials } from '@admin/utils/helpers';
        ...
        maxHeight: 'calc(100vh - 317px)'
          ...
          {currentThread ? currentThread.messages.map(message => <Fragment key={message.id}>
                {currentContact.id === message.senderId && <div className="d-flex align-items-start gap-2 my-3 chat-item">
                    {currentContact.image ? <img src={currentContact.image} width={36} height={36} className="avatar-md rounded-circle" alt="User" /> : <span className="avatar-sm flex-shrink-0">
                ...
                {currentUser.id === message.senderId && <div className="d-flex align-items-start gap-2 my-3 text-end chat-item justify-content-end">
                    ...
                    {currentUser.image ? <img src={currentUser.image} width={36} height={36} className="avatar-md rounded-circle" alt="User" /> : <span className="avatar-sm flex-shrink-0">
