import product1 from '@admin/assets/images/products/single-1.png';
import product2 from '@admin/assets/images/products/single-2.png';
import product3 from '@admin/assets/images/products/single-3.png';
import product4 from '@admin/assets/images/products/single-4.png';
...
const ProductDisplay = () => {
  ...
  return <Card className="card-top-sticky border-0">
