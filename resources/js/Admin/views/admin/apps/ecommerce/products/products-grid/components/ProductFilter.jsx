...
const renderTrack = ({
  ...
  width: '100%'
    ...
    <div ref={props.ref} suppressHydrationWarning style={{
    height: '4px',
    width: '100%',
    borderRadius: '4px',
...
const renderThumb = ({
  props
}) => <div suppressHydrationWarning {...props} key={props.key} style={{
  ...props.style,
  height: '16px',
  width: '16px',
  borderRadius: '50%',
          ...
          <CardBody className="p-0">
            ...
            <div className="p-3 border-bottom border-dashed">
              ...
              <Nav className="flex-column">
                {categoryData.map(category => <NavItem key={category.id} className="d-flex align-items-center gap-2 text-muted py-1">
            ...
            <div className="p-3 border-bottom border-dashed">
              ...
              {brandData.map(brand => <NavItem key={brand.id} className="d-flex align-items-center gap-2 text-muted py-1">
            ...
            <div className="p-3">
              ...
              {ratingData.map((rating, idx) => <div className="form-check py-1" key={idx}>
