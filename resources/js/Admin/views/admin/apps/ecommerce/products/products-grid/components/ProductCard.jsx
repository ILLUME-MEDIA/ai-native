...
const Page = ({
  ...
  return <Card className="h-100 mb-2">
      {discount && <Badge bg={discount > 20 ? 'success' : 'danger'} className="badge-label fs-base rounded position-absolute top-0 start-0 m-3">
          {discount}% OFF
        </Badge>}
