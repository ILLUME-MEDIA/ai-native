import ratingsImg from '@admin/assets/images/ratings.svg';
...
const ProductReviews = () => {
  const columns = [columnHelper.accessor('user', {
    ...
    cell: ({
      row
    }) => <span className={`badge fs-xxs ${row.original.status === 'published' ? 'badge-soft-success' : 'badge-soft-warning'}`}>{toPascalCase(row.original.status)}</span>
  }), {
    enableSorting: false,
    header: 'Actions',
