...
const SellerTable = () => {
  const columns = [{
    ...
    cell: ({
      row
    }) => <ApexChart getOptions={row.original.reportChartOptions} series={row.original.reportChartOptions().series} type={row.original.reportChartOptions().chart?.type} width={100} height={30} />
  })];
