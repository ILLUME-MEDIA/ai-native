  ...
  return <Card>
      <CardBody>
        <div className="ins-wizard">
          <Row>
            <Wizard header={<Col md={4} xxl={3}>
                  <Header />
                </Col>} wrapper={<Col md={8} xxl={9} />}>
              <GeneralInfo />
              <StoreDetails />
              <Branding />
              <CurrencyAndTax />
...
const Header = () => {
  ...
  return <Nav as="ul" className="nav flex-column wizard-bordered wizard-tabs nav-pills w-100" role="tablist">
      {settingStepsData.map((step, idx) => <li key={idx} className="nav-item">
