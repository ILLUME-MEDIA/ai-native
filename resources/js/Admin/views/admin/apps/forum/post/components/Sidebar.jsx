      ...
      <Card>
        ...
        <CardBody className="border-bottom border-dashed">
          ...
          <ul className="list-group list-group-flush fs-sm">
            {sidebarData.categories.map(category => <li key={category} className="list-group-item ps-0">
        ...
        <CardBody className="border-bottom border-dashed">
          ...
          <ul className="list-group list-group-flush fs-sm">
            {sidebarData.popularQuestions.map(question => <li key={question} className="list-group-item ps-0">
                <Link to="#" className="link-reset fw-medium">
                  {question}
                </Link>
              </li>)}
        ...
        <CardBody>
          ...
          <div className="d-flex flex-wrap gap-1">
            {sidebarData.tags.map(tag => <Link key={tag} to="#" className="btn btn-light btn-sm">
                {tag}
              </Link>)}
          </div>
        </CardBody>
