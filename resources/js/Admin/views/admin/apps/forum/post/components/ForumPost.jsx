...
const ForumPost = () => {
  return <>
      ...
      <Form className="mb-3">
        <div className="mb-3">
          <FormControl as="textarea" className="bg-light-subtle" id="form-control-textarea" rows={4} placeholder="Enter your message..." />
        </div>
      ...
      {forumRepliesData.map(reply => <div key={reply.id} className="d-flex mb-3 border border-dashed rounded p-3">
          ...
          <div className="flex-grow-1 ms-2">
            ...
            {reply.subReplies && reply.subReplies.map(sub => <div key={sub.id} className="d-flex mt-4">
                  <div className="flex-shrink-0">
