...
const GhostRoundedButtons = () => {
  return <Card>
      ...
      <CardBody>
        <p className="text-muted">
          Use <code>btn-ghost-**</code> with <code>.rounded-pill</code> to create ghost-style buttons with rounded corners that highlight on hover.
        </p>
  ...
  return <Card>
      ...
      <CardBody>
        ...
        <div className="d-flex flex-wrap gap-2">
          ...
          <Button variant="success" className="btn-soft-success" disabled>
            Success
          </Button>
