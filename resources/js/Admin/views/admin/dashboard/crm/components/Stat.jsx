                  ...
                  <Col xs="6">
                    ...
                    <div className="d-flex align-items-center gap-2 my-3">
                      ...
                      <h3 className="mb-0 fw-bold">
                        <CountUp end={item.value} start={0} duration={10} prefix={item.prefix} suffix={item.suffix} decimals={2} decimal="." />
                      </h3>
                    </div>
                    <p className="mb-0 text-muted">
                      <span className={`me-2 ${item.change >= 0 ? "text-success" : "text-danger"}`}>
                        {item.change >= 0 ? "" : ""}
                        {item.change}%{" "}
                        <Icon icon={item.change >= 0 ? "trending-up" : "trending-down"} className="ms-1" />
                      </span>
                      &nbsp;
