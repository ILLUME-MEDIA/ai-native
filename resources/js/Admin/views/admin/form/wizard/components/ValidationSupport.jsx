  ...
  return <>
      ...
      <ul className={clsx('nav nav-tabs wizard-tabs', className)} data-wizard-nav role="tablist">
        <li className="nav-item">
          <button className={clsx('nav-link', activeStep === 0 && 'active', activeStep > 0 && '')} onClick={() => goToStep(0)}>
        ...
        <li className="nav-item">
          <button className={clsx('nav-link', activeStep === 1 && 'active', activeStep > 1 && '')} onClick={() => goToStep(1)}>
            <span className="d-flex align-items-center">
        ...
        <li className="nav-item">
          <button className={clsx('nav-link', activeStep === 2 && 'active', activeStep > 2 && '')} onClick={() => goToStep(2)}>
            <span className="d-flex align-items-center">
        ...
        <li className="nav-item">
          <button className={clsx('nav-link', activeStep === 3 && 'active', activeStep > 3 && '')} onClick={() => goToStep(3)}>
            <span className="d-flex align-items-center">
        ...
        <li className="nav-item">
          <button className={clsx('nav-link', activeStep === 4 && 'active', activeStep > 4 && '')} onClick={() => goToStep(4)}>
            <span className="d-flex align-items-center">
...
const Step1 = ({
  ...
  const {
    validated,
    handleSubmit
  } = useValidatedForm(nextStep);
  return <Form noValidate validated={validated} onSubmit={handleSubmit} className={`pt-3 ${className}`}>
      <Row>
        <Col xl={6}>
        ...
        <Col xl={6}>
          <FormGroup className="mb-3">
            ...
            <Flatpickr className="form-control" placeholder="Select DOB" options={{
            dateFormat: 'd M, Y',
