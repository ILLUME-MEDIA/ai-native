      ...
      <Card>
        ...
        <CardBody>
          ...
          <Row className="g-3">
            ...
            <Col lg={6}>
              {['primary', 'secondary', 'info', 'success', 'warning', 'danger', 'dark', 'purple', 'soft-primary'].map((color, idx) => <TouchSpinInput buttonClassName="floating" inputClassName="border-0" key={idx} variant={color} value={100} className="mt-2" />)}
            </Col>
          </Row>
          <div className="my-4 border-top border-dashed" />
          <Row className="g-3">
