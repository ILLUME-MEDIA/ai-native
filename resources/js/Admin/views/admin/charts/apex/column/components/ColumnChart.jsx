...
import { getBasicColumnChart, getChartWithDataLabels, getColumnWithGroupLabelChart, getColumnWithMarkersChart, getDistributedColumnCharts, getDumbbellChart, getFullStackedColumnChart, getGroupedStackedColumnChart, getNegativeValueColumnChart, getRangeColumnCharts, getRotateLabelColumn, getStackedColumnChart } from './data';
  ...
  return <Card>
      ...
      <CardBody className="pt-3">
        <Row>
          ...
          <Col sm={6}>{quarterOptions && <ReactApexChart options={{
            ...quarterOptions,
            colors
          }} series={quarterData || []} type="bar" height={400} />}</Col>
        </Row>
      </CardBody>
    </Card>;
};
