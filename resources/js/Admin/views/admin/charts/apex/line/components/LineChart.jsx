...
import { createDailyTimeSeries, generateNewPoint, getBrushChart, getBrushChart2, getDashedLineChart, getGradientLineChart, getLineChart, getLineChartWithAnnotations, getMissingLineChart, getRealTimeChartOptions, getSimpleLineChart, getStepLineChart, getSyncingCharts, getSyncingCharts2, getZoomableTimeSeriesChart } from './data';
...
export const SteplineChart = () => {
  return <ApexChart getOptions={getStepLineChart} series={getStepLineChart().series} type="line" height={380} />;
};
