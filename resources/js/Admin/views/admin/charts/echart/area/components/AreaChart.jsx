...
export const BasicAreachart = () => {
  return <EChart extensions={[LineChart, CanvasRenderer]} getOptions={getAreaChart} style={{
    height: '300px'
  }} />;
};
export const StackedAreaChart = () => {
  return <EChart extensions={[LineChart, CanvasRenderer]} getOptions={getStackedAreaChart} style={{
    height: '300px'
  }} />;
};
export const AreaWithMarkersChart = () => {
  return <EChart extensions={[LineChart, CanvasRenderer]} getOptions={getAreaWithMarkerChart} style={{
    height: '300px'
  }} />;
};
export const StepArea = () => {
  return <EChart extensions={[LineChart, CanvasRenderer]} getOptions={getStepAreaChart} style={{
    height: '300px'
  }} />;
};
...
export const DynamicAreaChart = () => {
  ...
  return <EChart extensions={[LineChart, CanvasRenderer]} getOptions={getDynamicAreaChart} style={{
    height: '300px'
  }} />;
};