...
export const LineChart = () => {
  return <EChart extensions={[LinesChart, CanvasRenderer]} getOptions={getLineChart} style={{
    minHeight: '300px'
  }} />;
};
export const ChartLineStacked = () => {
  return <EChart extensions={[LinesChart, CanvasRenderer]} getOptions={getStackedLineChart} style={{
    height: '300px'
  }} />;
};
export const LineMarker = () => {
  return <EChart extensions={[LinesChart, CanvasRenderer]} getOptions={getLineMarkerChart} style={{
    height: '280px'
  }} />;
};
export const StepLineChart = () => {
  return <EChart extensions={[LinesChart, CanvasRenderer]} getOptions={getStepLine} style={{
    height: '300px'
  }} />;
};
export const LineYCategory = () => {
  return <EChart extensions={[LinesChart, CanvasRenderer]} getOptions={getLineYCategory} style={{
    height: '300px'
  }} />;
};
...
export const DynamicLine = () => {
  ...
  return <EChart extensions={[LineChart, CanvasRenderer]} getOptions={getDynamicLineChart} style={{
    height: '300px'
  }} />;
};