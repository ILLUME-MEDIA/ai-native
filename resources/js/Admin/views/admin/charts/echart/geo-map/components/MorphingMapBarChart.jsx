...
const MorphingMapBarChart = () => {
  ...
  return <>{loaded && <EChart extensions={[MapChart, BarChart, TooltipComponent, VisualMapComponent, GridComponent, GeoComponent, CanvasRenderer]} getOptions={getOptions} style={{
      height: '400px'
    }} />}</>;
};
