...
export const BasicGaugeEChart = () => {
  return <EChart extensions={[GaugeChart, CanvasRenderer]} getOptions={getGaugeChart} style={{
    height: '300px'
  }} />;
};
export const SpeedStageGaugeChart = () => {
  return <EChart extensions={[GaugeChart, CanvasRenderer]} getOptions={getSpeedStageGaugeChart} style={{
    height: '300px'
  }} />;
};
export const RingGaugeChart = () => {
  return <EChart extensions={[GaugeChart, CanvasRenderer]} getOptions={getRingGaugeChart} style={{
    height: '300px'
  }} />;
};
...
export const MultiRingGaugeChart = () => {
  return <EChart extensions={[GaugeChart, CanvasRenderer]} getOptions={getMultiRingGaugeChart} style={{
    height: '300px'
  }} />;
};
