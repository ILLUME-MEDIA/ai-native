import marketImg from '@admin/assets/images/leaflet/marker-icon.png';
import markerShadowImg from '@admin/assets/images/leaflet/marker-shadow.png';
...
const UserLocationMap = () => <MapContainer center={center} zoom={10} scrollWheelZoom={false} style={{
  height: '300px'
}}>
