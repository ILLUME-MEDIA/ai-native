          ...
          <Card>
            ...
            <CardBody>
              <div className="timeline">
                {basicTimelineData.map((item, idx) => <div key={idx} className="timeline-item d-flex align-items-stretch">
          ...
          <Card>
            ...
            <CardBody>
              <div className="timeline timeline-icon-based">
                {iconTimelineData.map((item, idx) => <div key={idx} className="timeline-item d-flex align-items-stretch">
                    {item.time && <div className="timeline-time pe-3 text-muted">{item.time}</div>}
                    {item.className && item.icon && <div className={`timeline-dot ${item.className}`}>
          ...
          <Card>
            ...
            <CardBody>
              <div className="timeline timeline-icon-bordered">
                {userTimelineData.map((item, idx) => <div key={idx} className="timeline-item d-flex align-items-stretch">
                    {item.time && <div className="timeline-time pe-3 text-muted">{item.time}</div>}
          ...
          <Card>
            ...
            <CardBody>
              <div className="timeline timeline-users">
                {borderTimelineData.map((item, idx) => <div key={idx} className="timeline-item d-flex align-items-stretch">
